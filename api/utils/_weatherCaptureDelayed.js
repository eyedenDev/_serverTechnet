...
const getWeatherData = async (id, treatmentFile, latitude, longitude) => {
  const /*treatmentFilepath = `../../weatherFiles/${treatmentFile}`,*/s
    insertQuery = `UPDATE _treatments SET ? WHERE id =?`;
  let captureInterval,
    captureData = null;
